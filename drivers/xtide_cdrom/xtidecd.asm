...
; IBMXT IBM PC/XT or comaptibles
...
ata_ports_ibmxt_primary:
    dw 320h, 321h, 322h, 323h, 324h, 325h, 326h, 327h, 32eh
ata_ports_ibmxt_secondary:
    dw 340h, 341h, 342h, 343h, 344h, 345h, 346h, 347h, 34eh
...
ATASelectPorts_ibmxt:
    mov bx, ata_ports_ibmxt_primary
    test al, 2
    jz .l2
    mov bx, ata_ports_ibmxt_secondary
  .l2:
    ret
...
cd_update_device_status:
  ...
  .l2:
    ...
    push cx
    mov cl, 4
    shl al, cl				; (cddriver: bit4 data or data+audio)
    pop cx
...
isPCAT:        ; detect PCAT
    ...
    jmp  short done
is_not_at:
    mov  byte [cs: is_xt], 01h
done:
    popf
    sub  al,bl ; 00 - 01 = FF, carry set
               ; 00 - 00 = 00, carry clear
    pop  bx
    pop  ax
    ret
...
SwitchToPCAT:
    mov word [cs: ata_select_ports], ATASelectPorts_ibm
    ret
