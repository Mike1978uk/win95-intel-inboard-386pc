...
| [#20](https://github.com/Mike1978uk/win95-intel-inboard-386pc/issues/20) | 86Box has no 3C509B device, so emulated networking cannot match the real machine's card. Fidelity only. Upstream [discussion #6447](https://github.com/86Box/86Box/discussions/6447) has the documents; our measured values are posted there |
...
| [#32](https://github.com/Mike1978uk/win95-intel-inboard-386pc/issues/32) | 3C509B: packet buffer size, and is it drained in bulk? Answerable from the packet driver binary, no hardware |
