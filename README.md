...
| [#27](https://github.com/Mike1978uk/win95-intel-inboard-386pc/issues/27) | LS-120 — **the vendor DOS driver corrupts large transfers** (small files are reliable; the owner has seen this before, and a DOS `FORMAT` also reported success while the result was wrong). The **Windows** path is unaffected and verified at 36,735,152 bytes byte-identical, so this is a vendor-tool defect we neither ship nor depend on. |
