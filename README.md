...
| [#27](https://github.com/Mike1978uk/win95-intel-inboard-386pc/issues/27) | LS-120 — writing to the drive from DOS over ECP corrupts everything past the first 16 KB. The first 16,384 bytes are correct and about 62% of the rest is not. Found 2026-09-20, the first time a DOS write to this drive was byte-verified; the source file was ruled out from a host card reader. The ECP **read** direction is verified good, so this is write-only |
