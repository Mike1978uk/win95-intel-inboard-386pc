...
|---|---|---|---|
| ~~**B1 = A3**~~ | ✅ **STOOD DOWN 2026-09-21.** Owner: *"it works and has been for a few weeks, sound works fine."* Sound DMAs into conventional memory every time it plays, so weeks of clean audio since the 09-11 switch change answers it. I had reasoned from dates to a risk; operational evidence outranks that | — | **B2 is now first** |
