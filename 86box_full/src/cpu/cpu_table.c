  ...
  // clang-format off
    ...
    },
    {
        ...
        .cpus          = (const CPU[]) {
            ...
            {
                /* 2026-07-26: added for this project's real, physically-modded Inboard 386/PC -
                   ...
                   Matches this project's own "real hardware is the source of truth" approach -
                   using the measured figure rather than a clean but apparently-too-low
                   theoretical calculation. mem/cache cycle counts linearly interpolated between
                   the existing 75/100 entries (their own accuracy is secondary for this project
                   anyway - inboard386.c's own apply_mem_timing()/apply_io_waitstates() override
                   the actual consumed CPU-core timing variables directly for the Inboard-driven
                   machine this speed grade is really being added for). */
                .name               = "83.5",
                .cpu_type           = CPU_IBM486BL,
                .fpus               = fpus_80386,
                .rspeed             = 83500000,
